...
def changeip(n):
	...
	try:
		os.system('''
		sudo protonvpn d
		sudo protonvpn c --cc '''+servers[n]+''' -p TCP''')
...
def gni(firefox,n):
	def Venom_actions(firefox,n):
		...
		try:
			...
			print('seu ip foi bloqueado, BOT_MASTER mudará para você')
